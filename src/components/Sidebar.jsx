...
function Sidebar() {
  ...
  return (
    <>
    <div className={`${mobileShow ? "fixed top-0 bottom-0 left-0 transition-all duration-300 bg-white z-40 h-screen w-[70%] sm:w-[30%]" 
      ...
      <br />
      <p className="text-xs text-gray-500 mt-3">© 2024 Ranjan Pandey</p>
    </div>
